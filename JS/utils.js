...
const obterFaixaInfo = (faixa) => {
    const faixas = {
        f1: { label: '(0-18)', descricao: '0 a 18 anos', min: 0, max: 18 },
        f2: { label: '(19-23)', descricao: '19 a 23 anos', min: 19, max: 23 },
        f3: { label: '(24-28)', descricao: '24 a 28 anos', min: 24, max: 28 },
        f4: { label: '(29-33)', descricao: '29 a 33 anos', min: 29, max: 33 },
        f5: { label: '(34-38)', descricao: '34 a 38 anos', min: 34, max: 38 },
        f6: { label: '(39-43)', descricao: '39 a 43 anos', min: 39, max: 43 },
        f7: { label: '44-48)', descricao: '44 a 48 anos', min: 44, max: 48 },
        f8: { label: '(49-53)', descricao: '49 a 53 anos', min: 49, max: 53 },
        f9: { label: '(54-58)', descricao: '54 a 58 anos', min: 54, max: 58 },
        f10: { label: '(59+)', descricao: '59 anos ou mais', min: 59, max: 999 }
    };
...
const obterTodasFaixas = () => {
    return [
        { id: 'f1', label: '(0-18)', descricao: '0 a 18 anos' },
        { id: 'f2', label: '(19-23)', descricao: '19 a 23 anos' },
        { id: 'f3', label: '24-28)', descricao: '24 a 28 anos' },
        { id: 'f4', label: '(29-33)', descricao: '29 a 33 anos' },
        { id: 'f5', label: '(34-38)', descricao: '34 a 38 anos' },
        { id: 'f6', label: '(39-43)', descricao: '39 a 43 anos' },
        { id: 'f7', label: '44-48)', descricao: '44 a 48 anos' },
        { id: 'f8', label: '49-53)', descricao: '49 a 53 anos' },
        { id: 'f9', label: '(54-58)', descricao: '54 a 58 anos' },
        { id: 'f10', label: '(59+)', descricao: '59 anos ou mais' }
    ];
};
